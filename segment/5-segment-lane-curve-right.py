...
while cap.isOpened():
    ...
    for result in results:
        ...
        cv2.polylines(gray_frame_bgr, curve_points, isClosed=False, color=(0, 0, 255), thickness=5)

        # Dibujar la línea verde en la parte inferior de la imagen
        cv2.line(gray_frame_bgr, (0, MAX_ALTURA_Y), (gray_frame_bgr.shape[1], MAX_ALTURA_Y), color=(0, 255, 0), thickness=2)

        # Guardar la imagen con la curva dibujada
        cv2.imwrite("output_with_curve_right.jpg", gray_frame_bgr)
